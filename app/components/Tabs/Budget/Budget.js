...
export default class Budget extends React.Component {
  ...
  render() {
    ...
    <div className="progress-bar progress-bar-success" width='40%'>
      Free Space
    </div>
    {/* <div className="progress-bar progress-bar-warning"  styleName ="width:10%">
      Warning
    </div>
    <div className="progress-bar progress-bar-danger"  styleName="width:20%">
      Danger
    </div> */}
  </div>
